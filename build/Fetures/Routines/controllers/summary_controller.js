    ...
    try {
        ...
        switch (save) {
            ...
            case 'false':
                ...
                const ifSaved = yield save_summary_model_1.default.findOne({
                    summaryId: foundSummary._id,
                    routineId: foundSummary.routineId,
                    savedByAccountId: req.user.id,
                });
                ...
                yield save_summary_model_1.default.findOneAndDelete({
                    summaryId: foundSummary._id,
                    routineId: foundSummary.routineId,
                    savedByAccountId: req.user.id,
                });
...
const remove_summary = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield save_summary_model_1.default.deleteMany({ summaryId: summary_id }).session(session);
        // Step 2: Delete the summary from MongoDB
        yield summary_models_1.default.findByIdAndDelete(summary_id).session(session);
