...
exports.permission_edit_priode = exports.permission_remove_priode = exports.permission_add_Pride = exports.peremption_add_member = void 0;
// Models
...
const permission_remove_priode = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { priodeId } = req.params;
    try {
        // 1. Find Routine and Priode
        const priode = yield priode_Models_1.default.findById(priodeId);
        if (!priode)
            return res.status(404).json({ message: "Priode not found" });
...
exports.permission_remove_priode = permission_remove_priode;
// peremption to edit priode
// permission_remove_priode
const permission_edit_priode = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { priodeId } = req.params;
    const { id } = req.user;
    try {
        // 1. Find Routine and Priode
        ...
        if (!routine)
            return res.status(404).json({ message: "Routine not found" });
        // 2. Check permission is owner or captain
        const routineMember = yield routineMembers_Model_1.default.findOne({ RutineID: routineID, memberID: id });
        if (!(routineMember === null || routineMember === void 0 ? void 0 : routineMember.owner) && !(routineMember === null || routineMember === void 0 ? void 0 : routineMember.captain)) {
...
exports.permission_edit_priode = permission_edit_priode;
