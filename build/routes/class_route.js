...
//
// 3
app.post('/:rutin_id/addclass', varifitoken_1.verifyToken, class_validation_1.classValidation, class_controllers_1.create_class);
...
//
app.get('/:rutin_id/:weekday', class_controllers_1.show_weekday_classes);
app.get('/:rutin_id/all/class', class_controllers_1.allclass);
app.post('/:rutin_id/all/class', varifitoken_1.verifyToken, class_controllers_1.allclass);
...
//
// weekday
app.post('/weakday/add/:class_id', weekday_validation_1.weekdayValidation, routines_middleware_1.validateWeekdayMiddleware, class_controllers_1.addWeakday);
